...
class NetCDFFile():
    ...
    def create_time(self, t, ref='01/01/1981'):
        ...
        self.variables['time'] = self.ncout.createVariable('time', 'i4', ('time',))
        ...
        self.variables['time'][:] = seconds_from_ref(t, ref_dt)
        self.variables['time'].units = f"seconds since {ref_dt.strftime('%Y-%m-%d %H:%M:%S')}"
